...
class ascii_by_pca_L1:
    ...
    def patch2ascii(self, img, n=5):
        ...
        for i in range(limit):
            ...
            l1 = self.l1_norm(patch_pca, ascii_patch)
            if l1 < min_l1:
                min_l1 = l1
                min_l1_position = i

        return ascii_dataset[min_l1_position][0]
    
    def img2ascii_file(self):
        file_out_path = f'{self.output_name}_L1_1pca_{self.pca_components}_{self.style}.txt'
...
# obj1.data_prep(img_path, tahoma, 80, 5)
# obj1.img2ascii_file()
